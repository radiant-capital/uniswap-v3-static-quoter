...
contract UniswapV3StaticQuoter is IUniswapV3StaticQuoter, UniV3QuoterCore {
    ...
    function quoteExactOutputSingle(QuoteExactOutputSingleParams memory params) public view returns (uint256 amountIn) {
        bool zeroForOne = params.tokenIn < params.tokenOut;
        IUniswapV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
    ...
    function quoteExactOutput(bytes memory path, uint256 amountOut) public view returns (uint256 amountIn) {
        while (true) {
            ...
            amountOut = quoteExactOutputSingle(QuoteExactOutputSingleParams(tokenIn, tokenOut, amountOut, fee, 0));
