    ...
    function calcReachAmount(
        ...
        if (isExactInput) {
            ...
            if (isToken0) {
                ...
                uint256 numerator = FullMath.mulDivFloor(liquidity, TWO_FEE_UNITS * absPriceDiff, denominator);
    ...
    function estimateIncrementalLiquidity(
        ...
        if (isExactInput) {
            if (isToken0) {
                ...
                deltaL = FullMath.mulDivFloor(currentSqrtP, absDelta * feeInFeeUnits, TWO_FEE_UNITS << RES_96);
            } else {
                // deltaL = feeInFeeUnits * absDelta * / (currentSqrtP * 2)
                ...
                deltaL = FullMath.mulDivFloor(TWO_POW_96, absDelta * feeInFeeUnits, TWO_FEE_UNITS * currentSqrtP);
            }
        } else {
